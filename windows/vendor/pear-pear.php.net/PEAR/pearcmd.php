...
if ('C:\wamp\www\skilltrawller\windows\vendor/pear-pear.php.net/PEAR ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('C:\wamp\www\skilltrawller\windows\vendor/pear-pear.php.net/PEAR '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
